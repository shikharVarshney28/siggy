...
const Header = () => {
  return (
    <>
      <nav className='bg-black border-2 flex pt-3 pr-6 pl-4 pb-4 justify-between'>
        <svg className='ml-10 VXJlj' viewBox="0 0 61 61" height="49" width="49">
          <g clipPath="url(#a)">
            <path
              fill="#FF5200"
        ...
        <ul className='flex'>
          <div className='ml-18 text-white font-bold text-2xl flex items-center'>
            <span className='m-2'><FaSearch /></span>
            <Link to="/search"><li>Search</li></Link>
          </div>
          <div className='ml-18 text-white font-bold text-2xl flex items-center'>
            <span className='m-2'><IoIosHelpBuoy /></span>
           <Link to='/offers'> <li>Offers<sup className='text-orange-500'>New</sup></li></Link>
          </div>
          <div className='ml-18 text-white font-bold text-2xl flex items-center'>
            <span className='m-2'><IoIosHelpBuoy /></span>
          ...
          <div className='ml-18 text-white font-bold text-2xl flex items-center'>
            <span className='m-2'><CiLogin /></span>
            <Link to='/signin'><li>Sign In</li></Link>
          </div>
          <div className='ml-18 text-white font-bold text-2xl flex items-center'>
            <span className='m-2'><FaShoppingCart /></span>
            <Link to="/cart"><li>Cart</li></Link>
          </div>

          <div className='ml-18 text-white font-bold text-2xl flex items-center'>
            <span className='m-2'><FaHome /></span>
